...
/*modbus_ascii function*/
MODBUS_API int _modbus_asc_check_intergrity(modbus_t *ctx,uint8_t *msg,uint8_t *asc_msg,int asc_msg_length,int msg_length);
MODBUS_API int _modbus_asc_send_msg_pre(uint8_t *req, int req_length,uint8_t *req_asc);
...
MODBUS_API void modbus_set_debug_log(modbus_t *ctx, void (*print_log) (int slave, int direction, char *msg, int length));
